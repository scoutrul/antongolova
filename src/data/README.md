...
3. Карточка: добавь элемент в `src/data/ru/cases.json` (slug/title/description/image/year), `image` — обложка из `public/assets/cases/<slug>/`, `year` — год проекта (например, 2026).
